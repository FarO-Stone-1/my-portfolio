    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-slate-950/60 border-b border-slate-800/80 shadow-lg shadow-black/20">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
        ...
        <button 
          ...
          className="text-white font-mono font-bold text-xs sm:text-base tracking-tight hover:text-blue-400 transition-colors text-left truncate cursor-pointer"
        >
          asarekofiaikins.dev
        </button>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <button
                  ...
                  className={`px-2.5 sm:px-3.5 py-1.5 rounded-xl text-xs sm:text-sm font-medium transition-all duration-300 backdrop-blur-md border cursor-pointer ${
                    isActive
